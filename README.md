...
This is an early build for playtesting. Two things the team most wants feedback on:

1. **How a busy evening feels** — do queues read as queues, does the doorway congest?
2. **The sound mix** — the arcade's own noise against the radio.
